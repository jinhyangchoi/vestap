...
import vestap.sys.bbs.suggestion.SuggestionBoardController;
import vestap.sys.bbs.suggestion.SuggestionBoardServiceImpl;
...
private static final Logger logger = LoggerFactory.getLogger(SuggestionBoardController.class);
	
	@Resource(name = "suggestionBoardService")
	private SuggestionBoardServiceImpl SERVICE;
	
	@Resource(name = "utilityComponent")
	private UtilityComponent utilComp;
	
	@RequestMapping(value = "/member/base/board/suggestion/list.do", method = {RequestMethod.GET, RequestMethod.POST})
	public String suggestionList(ModelMap model, HttpServletRequest request, @RequestParam(required = false) Map<String, String> params) {
		...
		String viewName = "board/suggestion/list";
	...
	@RequestMapping(value = "/member/base/board/suggestion/content.do", method = {RequestMethod.GET, RequestMethod.POST})
	@ResponseBody
	...
	@RequestMapping(value = "/member/base/board/suggestion/write.do", method = {RequestMethod.GET, RequestMethod.POST})
	public String suggestionWrite(ModelMap model) {
		
		String viewName = "board/suggestion/write";
	...
	@RequestMapping(value = "/member/base/board/suggestion/insert.do", method = {RequestMethod.GET, RequestMethod.POST})
	public RedirectView suggestionInsert(ModelMap model,
		...
		return new RedirectView("/member/base/board/suggestion/list.do");
	}
	
	@RequestMapping(value = "/member/base/board/suggestion/download.do", method = {RequestMethod.GET, RequestMethod.POST})
	...
	@RequestMapping(value = "/member/base/board/suggestion/modify.do", method = {RequestMethod.GET, RequestMethod.POST})
	public String suggestionModify(ModelMap model, HttpServletRequest request, @RequestParam(value = "idx", required = true) String idx) {
		
		String viewName = "board/suggestion/modify";
	...
	@RequestMapping(value = "/member/base/board/suggestion/update.do", method = {RequestMethod.GET, RequestMethod.POST})
	...
	@RequestMapping(value = "/member/base/board/suggestion/delete.do", method = {RequestMethod.GET, RequestMethod.POST})
