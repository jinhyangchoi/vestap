...
@Service("suggestionBoardService")
@Transactional
public class SuggestionBoardServiceImpl extends EgovAbstractServiceImpl implements SuggestionBoardService {
	
	@Resource(name = "suggestionBoardDAO")
