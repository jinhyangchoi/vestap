...
public class FaqBoardController {
	...
	private FaqBoardServiceImpl SERVICE;
	
	@Resource(name = "utilityComponent")
	private UtilityComponent utilComp;
	
	@RequestMapping(value = "/member/base/board/faq/list.do", method = {RequestMethod.GET, RequestMethod.POST})
	public String faqList(ModelMap model, @RequestParam(required = false) Map<String, String> params) {
		
		String viewName = "board/faq/list";
	...
	@RequestMapping(value = "/member/base/board/faq/content.do", method = {RequestMethod.GET, RequestMethod.POST})
	@ResponseBody
	...
	public String faqWrite(ModelMap model) {
		...
		String viewName = "board/faq/write";
	...
	public RedirectView faqInsert(ModelMap model,
		...
		return new RedirectView("/member/base/board/faq/list.do");
	}
	*/
	@RequestMapping(value = "/member/base/board/faq/download.do", method = {RequestMethod.GET, RequestMethod.POST})
	...
	public String faqModify(ModelMap model, @RequestParam(value = "idx", required = true) String idx) {
		...
		String viewName = "board/faq/modify";
