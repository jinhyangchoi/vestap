...
public class ReferenceBoardController {
	...
	private static final Logger logger = LoggerFactory.getLogger(ReferenceBoardController.class);
	
	@Resource(name = "referenceBoardService")
	private ReferenceBoardServiceImpl SERVICE;
	
	@Resource(name = "utilityComponent")
	private UtilityComponent utilComp;
	
	@RequestMapping(value = "/member/base/board/reference/list.do", method = {RequestMethod.GET, RequestMethod.POST})
	public String referenceList(ModelMap model, @RequestParam(required = false) Map<String, String> params) {
		
		String viewName = "board/reference/list";
	...
	@RequestMapping(value = "/member/base/board/reference/content.do", method = {RequestMethod.GET, RequestMethod.POST})
	@ResponseBody
	...
	public String referenceWrite(ModelMap model) {
		...
		String viewName = "board/reference/write";
	...
	public RedirectView referenceInsert(ModelMap model,
		...
		return new RedirectView("/member/base/board/reference/list.do");
	}
	*/
	@RequestMapping(value = "/member/base/board/reference/download.do", method = {RequestMethod.GET, RequestMethod.POST})
	...
	public String referenceModify(ModelMap model, @RequestParam(value = "idx", required = true) String idx) {
		...
		String viewName = "board/reference/modify";
