...
public class SysItemController {
	...
	private SysItemServiceImpl SERVICE;
	
	@RequestMapping(value = "/admin/system/item/list.do", method = {RequestMethod.GET, RequestMethod.POST})
	public String itemList(ModelMap model, HttpServletRequest request) {
		
		String viewName = "admin/system/item";
	...
	/** 
	 * 시스템정의취약성
	 * - 항목 리스트 선택 시 info 불러오기
	 **/
	@RequestMapping(value = "/admin/system/item/itemInfo.do", method = {RequestMethod.GET, RequestMethod.POST})
	@ResponseBody
	public ModelAndView itemInfo(HttpServletRequest request,
		...
		if(item_id.substring(0, 2).equals("TL")) {
			...
			params.put("listTable", "ITEM_LIST_SYS");
			params.put("dataTable", "ITEM_INDICATOR_SYS");
	 ...
	 * - 항목 리스트 페이징 이동시
	 **/
	@RequestMapping(value = "/admin/system/item/fieldItem.do", method = {RequestMethod.GET, RequestMethod.POST})
	@ResponseBody
	...
	@RequestMapping(value = "/admin/system/item/isItemName.do", method = {RequestMethod.GET, RequestMethod.POST})
	@ResponseBody
	...
	@RequestMapping(value = {"/admin/system/item/insert.do", "/admin/system/item/update.do"}, method = {RequestMethod.GET, RequestMethod.POST})
	public RedirectView itemInsert(HttpServletRequest request,
		...
		try {
			...
			if(request.getRequestURL().toString().contains("/admin/system/item/insert")) {
				System.out.println("***********************************************************************");
		...
		return new RedirectView("/admin/system/item/list.do");
	}
	
	@RequestMapping(value = "/admin/system/item/delete.do", method = {RequestMethod.GET, RequestMethod.POST})
	...
	@RequestMapping(value = "/admin/system/item/indicator.do", method = {RequestMethod.GET, RequestMethod.POST})
	@ResponseBody
	...
	@RequestMapping(value = "/admin/system/item/templateItem.do", method = {RequestMethod.GET, RequestMethod.POST})
	@ResponseBody
