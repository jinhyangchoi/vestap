...
@Service("sysIndicatorService")
@Transactional
public class SysIndicatorServiceImpl extends EgovAbstractServiceImpl implements SysIndicatorService{

	@Resource(name = "sysIndicatorDAO")
	private SysIndicatorDAO DAO;
	...
	public List<Map<String, String>> getDistrictSdInfo(Map<String, Object> params) throws Exception {
		return this.DAO.getDistrictSdInfo(params);
	}
	...
	public String indicatorDownload(VestapUserDetails details) throws Exception {
		...
		} else if(details.getUser_auth().equals("A")){
	...
	public Map<String, String> getSysIndicatorList(Map<String, Object> params) throws Exception {
		return this.DAO.getSysIndicatorList(params);
	}
	...
	public void insertIndicatorSelf(Map<String, Object> params) throws Exception {
		...
		String idx = "IC" + String.format("%06d", seq);
