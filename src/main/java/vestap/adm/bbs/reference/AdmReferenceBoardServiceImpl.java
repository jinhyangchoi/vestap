...
@Service("admReferenceBoardService")
@Transactional
public class AdmReferenceBoardServiceImpl extends EgovAbstractServiceImpl implements AdmReferenceBoardService {
	
	@Resource(name = "admReferenceBoardDAO")
	private AdmReferenceBoardDAO DAO;
