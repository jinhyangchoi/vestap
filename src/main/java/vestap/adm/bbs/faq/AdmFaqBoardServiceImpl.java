...
@Service("admFaqBoardService")
@Transactional
public class AdmFaqBoardServiceImpl extends EgovAbstractServiceImpl implements AdmFaqBoardService {
	
	@Resource(name = "admFaqBoardDAO")
	private AdmFaqBoardDAO DAO;
