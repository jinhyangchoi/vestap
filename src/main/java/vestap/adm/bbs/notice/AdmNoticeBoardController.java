...
@Controller
public class AdmNoticeBoardController {
	
	private static final Logger logger = LoggerFactory.getLogger(AdmNoticeBoardController.class);
	
	@Resource(name = "AdmNoticeBoardService")
	private AdmNoticeBoardServiceImpl SERVICE;
	
	@Resource(name = "utilityComponent")
	private UtilityComponent utilComp;
	
	@RequestMapping(value = "/admin/board/notice/list.do", method = {RequestMethod.GET, RequestMethod.POST})
	public String noticeList(ModelMap model, @RequestParam(required = false) Map<String, String> params) {
		
		String viewName = "admin/board/notice/list";
	...
	@RequestMapping(value = "/admin/board/notice/content.do", method = {RequestMethod.GET, RequestMethod.POST})
	@ResponseBody
	...
	public String noticeWrite(ModelMap model) {
		...
		String viewName = "admin/board/notice/write";
	...
	public RedirectView noticeInsert(ModelMap model,
		...
		return new RedirectView("/admin/board/notice/list.do");
	}
	
	@RequestMapping(value = "/admin/board/notice/download.do", method = {RequestMethod.GET, RequestMethod.POST})
	...
	public String noticeModify(ModelMap model, @RequestParam(value = "idx", required = true) String idx) {
		...
		String viewName = "admin/board/notice/modify";
