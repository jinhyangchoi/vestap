...
@Repository("admSuggestionBoardDAO")
public class AdmSuggestionBoardDAO extends EgovComAbstractDAO {
	...
	public void setSuggestionRefBoard(BoardVO vo) throws Exception {
		insert("suggestion.setSuggestionRefBoard", vo);
	}
}
