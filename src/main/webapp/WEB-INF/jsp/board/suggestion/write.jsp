...
<title>VESTAP - 열린마당 - 건의사항 등록</title>
...
<form id="board-insert" action="/member/base/board/suggestion/insert.do?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
