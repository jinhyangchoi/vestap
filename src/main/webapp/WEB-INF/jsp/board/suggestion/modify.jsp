...
<form id="board-insert" action="/member/base/board/suggestion/update.do?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
