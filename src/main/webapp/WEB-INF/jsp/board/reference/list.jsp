		...
		<td class="col align-top p-0">
			...
			<div class="mainContents"><!-- mainContents -->
				...
				<div class="navbar p-0 pb-3">
					...
					<div class="contentsTitle"><i class="icon-download-disk"> </i>자료실</div>
				...
				<table class="table table-hover vestapTable mainTable">
					...
					<c:forEach items="${boardList }" var="list">
						<tr class="offcanvas-select" onclick="javascript:linkContent('/member/base/board/reference/content.do', '${list.bbs_idx}');">
				...
				<sec:authorize access="hasRole('ROLE_ADMIN')">
					<div class="nav navbar p-0 mt-4 justify-content-center">
						...
						<!-- <button type="button" class="btn btn-vestap btn-blue w-auto pl-2 pr-2" onclick="location.href='/admin/board/reference/write.do'"><i class="icon-add-bold"></i>자료 등록</button> -->
					</div>
				</sec:authorize>
					...
					<li class="list-group-item p-4">
						...
						<span class="borad-dete float-right">
							<span class="borad-dete-val bbs_view" id="bbs_management">
								<button type="button" class="btn btn-vestap btn-blue w-auto pl-2 pr-2 mr-1" onclick="location.href='/admin/board/reference/delete.do'"><i class="icon-folder-delete-01"></i>삭제</button>
...
<form id="listFrm" action="/member/base/board/reference/list.do">
...
$(document).ready(function() {
	...
	linkContent("/member/base/board/reference/content.do", "${mainIdx}");
	offcanvasOpen();
