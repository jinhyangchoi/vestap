...
<title>VESTAP - 열린마당 관리- 공지사항(관리자전용)</title>
		...
		<td class="col align-top p-0">
			...
			<div class="mainContents"><!-- mainContents -->
				...
				<div class="navbar p-0 pb-3">
					...
					<div class="contentsTitle"><i class="icon-notice"> </i>공지사항</div>
				...
				<table class="table table-hover vestapTable mainTable">
					...
					<c:forEach items="${boardList }" var="list">
						<tr class="offcanvas-select" onclick="javascript:linkContent('/member/base/board/notice/content.do', '${list.bbs_idx}');">
				...
				<sec:authorize access="hasAnyRole('ROLE_WIDE', 'ROLE_BASE')">
				 ...
				 --%>
					...
					<div class="nav navbar p-0 mt-4">
						...
						<button type="button" class="btn btn-vestap btn-blue w-auto pl-2 pr-2" onclick="location.href='/admin/board/notice/write.do'"><i class="icon-add-bold"></i>공지사항 등록</button>
					</div>
			...
			<div class="card notice board-content" style="height: 1450px"><!-- 리스트 수가 20개이거나 20개나 안될 경우 높이 입니다 -->
				...
				<ul class="list-group list-group-flush">
					...
					<!-- 관리자 접속시 <sec:authorize access="hasRole('ROLE_ADMIN')"> </sec:authorize>-->
					
					<li class="list-group-item p-4">
						
						<span class="borad-dete float-left">
							<span class="borad-dete-val bbs_view" id="bbs_management">
							<!-- 
								<button type="button" class="btn btn-vestap btn-blue w-auto pl-2 pr-2 mr-1" onclick="location.href='/admin/board/notice/delete.do'"><i class="icon-folder-delete-01"></i>삭제</button>
...
<form id="listFrm" action="/admin/board/notice/list.do">
