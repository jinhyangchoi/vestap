...
<title>VESTAP - 열린마당 관리- 건의사항(관리자전용)</title>
			...
			<div class="mainContents"><!-- mainContents -->
				...
				<table class="table table-hover vestapTable mainTable">
					...
					<div class="nav navbar p-0 mt-4 justify-content-center">
						...
						<!-- <button type="button" class="btn btn-vestap btn-blue w-auto pl-2 pr-2" onclick="location.href='/admin/board/suggestion/write.do'"><i class="icon-add-bold"></i>건의사항 등록</button> -->
					</div>
...
<form id="listFrm" action="/admin/board/suggestion/list.do">
