...
<title>VESTAP - 열린마당 관리- 자료실(관리자전용) 등록</title>
...
<form id="board-insert" action="/admin/board/reference/insert.do?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
			...
			<div class="mainContents"><!-- mainContents -->
				<div class="card">
					<div class="card-header p-2">
						...
						<div class="row">
							<div class="col-8 p-1 pl-4">자료 등록</div>
