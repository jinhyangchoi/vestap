...
<title>VESTAP - 사용자 정의 항목 생성</title>
...
<table class="offcanvas-table">
	<tr>
		...
		<div class="card">
			...
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item sub-title border-top-0"><i class="icon-file-align"></i>사용자정의 평가항목</li>
				<li class="list-group-item">
	...
	<td class="col align-top p-0">
		...
		<form id="custom-form" action="/member/base/custom/item/insert.do?${_csrf.parameterName}=${_csrf.token}">
		...
		<div class="mainContents item-view-category active" id="item-insert-view"><!-- mainContents -->
			...
			<div class="mt-3 text-center">
				...
				<button class="btn btn-vestap btn-blue mr-3" type="button" id="custom-insert"><i class="icon-file-write-add"></i>등록하기</button>
			</div>
...
<script src="/resources/js/developer/custom-item.js"></script>
</body>
</html>