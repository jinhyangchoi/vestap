...
<div class="error-container">
	...
	<div class="error-msg-container">
		<div class="error-header">
			...
			<div class="error-title error-justify">기후변화취약성 평가도구 시스템</div>
		</div>
		<div class="error-content">
			<div class="error-code error-justify">400 bad request</div>
			<div class="error-msg">
				<ul>
					<li><i class="icon-check-01"></i>서버와의 통신 중 장애가 발생 했습니다.</li>
