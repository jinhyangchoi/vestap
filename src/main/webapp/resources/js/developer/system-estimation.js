...
function fn_climateOption(mdl_id, rcp_id) {
	...
	$.ajax({
		url: "/admin/system/estimation/climateOption.do",
		type: "get",
		data: params,
		dataType: "json",
...
function fn_refIndicatorInfo(indi_id, page) {
	...
	$.ajax({
		url: "/admin/system/estimation/refIndicatorInfo.do",
		type: "get",
...
function fn_refIndicatorBase() {
	...
	$.ajax({
		url: "/admin/system/estimation/refIndicator.do",
		type: "get",
...
function fn_estimation(item_id, page) {
	...
	if($("#resultType option:selected").val() == "none") {
		return false;
	}
	...
	$.ajax({
		url: "/admin/system/estimation/vulAssessment.do",
		type: "get",
...
function fn_pageInfo(totalCount, page) {
	...
	$.ajax({
		url: "/admin/system/estimation/page.do",
		type: "get",
...
function fn_district(district_cd) {
	...
	$.ajax({
		url: "/admin/system/estimation/district.do",
		type: "get",
...
function fn_downloadEstimation() {
	...
	location.href = encodeURI("/admin/system/estimation/downloadEstimation.do?" + params);
}
